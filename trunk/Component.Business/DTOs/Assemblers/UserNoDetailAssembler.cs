...
namespace JobsInABA.BL.DTOs.Assemblers
{
    ...
    public static partial class UserNoDetailAssembler
    {
        ...
        public static User ToNoDetailEntity(this UserDTO dto)
        {
        ...
        public static UserNoDetailDTO ToNoDetailDTO(this User entity)
        {
            if (entity == null) return null;

            var dto = new UserNoDetailDTO();
        ...
        public static List<User> ToEntities(this IEnumerable<UserDTO> dtos)
        {
            ...
            return dtos.Select(e => e.ToNoDetailEntity()).ToList();
        }
        ...
        /// <returns></returns>
        public static List<UserNoDetailDTO> ToDTOs(this IEnumerable<User> entities)
        {
            if (entities == null) return null;

            return entities.Select(e => e.ToNoDetailDTO()).ToList();
        }
