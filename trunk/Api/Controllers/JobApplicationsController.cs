...
namespace Api.Controllers
{
    public class JobApplicationsController : ApiController
    {
        ...
        public IEnumerable<JobApplication> GetJobApplicationByUserID(int id)
        {
            var temp =db.GetJobApplications().Where(p => p.ApplicantUserID == id).ToList();
            return temp;
        }
        ...
        public IHttpActionResult PostJobApplication(JobApplication jobApplication)
        {
            ...
            //jobApplication.ApplicantUserID = 50;
            //jobApplication.ApplicationDate = DateTime.Now;
            //jobApplication.JobID = 20;
